...
export const User = ({id, first_name, last_name, email, avatar, onClickInvite, isInvited}) => (
    <li>
        <div>
            <img className="avatar" src={avatar} alt="Users" />
            <div>
                <h3>
        ...
        <svg onClick={() => onClickInvite(id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${isInvited ? 'action-delete ' : 'action '}` + 'w-6 h-6'}>
